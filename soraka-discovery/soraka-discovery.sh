...
#应用名称
APP_NAME=soraka-discovery

#需要启动的Java主程序（main方法类）
APP_MAINCLASS=soraka-discovery-0.0.1-SNAPSHOT.jar
...
nohup $JAVA_HOME/bin/java $JAVA_OPTS -jar $APP_MAINCLASS >/var/log/soraka/$APP_NAME.log &
